...
<div style="text-align: center;">
    ...
    <form action="updateBoard" method="post">
        <input type="hidden" name="pdcode" value="${Pdboard.pdcode}"/>
        <table style="width: 700px; margin: auto">
            ...
            <tr>
                ...
                <td><textarea name="content" cols="40" rows="10">${Pdboard.content}</textarea></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input  type="text" name="price" value="${Pdboard.price}"/></td>
            </tr>
            <tr>
                <td colspan="2">
                    <div style="text-align: center;">
